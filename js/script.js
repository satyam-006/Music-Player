...
//         audioPlayer.src = "songs/" + filename; // Assuming "songs" is the folder where your songs are stored
//         audioPlayer.play();
...
//         var currentIndex = songFilenames.indexOf(document.getElementById("songTitle").textContent);
